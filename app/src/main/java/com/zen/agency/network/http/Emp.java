...
package com.zen.agency.network.http;
...
public class Emp {
    ...
    public static class Builder {
        ...
        public Builder withEmpActive(Long empActive) {
            mEmpActive = empActive;
            return this;
        }

        public Builder withEmpApiKey(String empApiKey) {
            mEmpApiKey = empApiKey;
            return this;
        }

        public Builder withEmpCityId(Long empCityId) {
            mEmpCityId = empCityId;
            return this;
        }

        public Builder withEmpCreatedAt(String empCreatedAt) {
            mEmpCreatedAt = empCreatedAt;
            return this;
        }

        public Builder withEmpFirebaseToken(String empFirebaseToken) {
            mEmpFirebaseToken = empFirebaseToken;
            return this;
        }

        public Builder withEmpHomePhone(String empHomePhone) {
        ...
        public Builder withEmpLat(String empLat) {
            mEmpLat = empLat;
            return this;
        }

        public Builder withEmpLng(String empLng) {
            mEmpLng = empLng;
            return this;
        }

        public Builder withEmpMinumPrice(Long empMinumPrice) {
            mEmpMinumPrice = empMinumPrice;
            return this;
        }

        public Builder withEmpName(String empName) {
            mEmpName = empName;
            return this;
        }

        public Builder withEmpPassword(String empPassword) {
            mEmpPassword = empPassword;
            return this;
        }

        public Builder withEmpPermisson(Long empPermisson) {
            mEmpPermisson = empPermisson;
            return this;
        }

        public Builder withEmpPhone(String empPhone) {
            mEmpPhone = empPhone;
            return this;
        }

        public Builder withEmpPicUrl(String empPicUrl) {
            mEmpPicUrl = empPicUrl;
            return this;
        }

        public Builder withEmpPriceDelivery(Long empPriceDelivery) {
            mEmpPriceDelivery = empPriceDelivery;
            return this;
        }

        public Builder withEmpTimeLunch(Long empTimeLunch) {
            mEmpTimeLunch = empTimeLunch;
            return this;
        }

        public Builder withEmpTypeDelivery(Long empTypeDelivery) {
        ...
        public Builder withFeedBackNumber(Long feedBackNumber) {
